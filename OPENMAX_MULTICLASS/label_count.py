...
# 디렉토리 경로 설정
label_dir = 'final_data_trash_removed_v2/labels'  # .txt 라벨 파일들이 있는 디렉토리
yaml_path = 'merged_data/data.yaml'     # data.yaml 경로
output_dir = 'final_data_trash_removed_v2'                   # 저장 디렉토리
