...
# 디렉토리 경로 설정
label_dir = 'A_k10_runs_70per/run_1_test/train/labels'  # .txt 라벨 파일들이 있는 디렉토리
yaml_path = 'A_k10_runs/run_1_test/data.yaml'     # data.yaml 경로
output_dir = 'A_k10_runs_70per/run_1_test/train'                   # 저장 디렉토리
