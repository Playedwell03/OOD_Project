...
# 10개의 '학습된 모델'이 있는 폴더
MODELS_BASE_DIR = 'models_k10_runs_10per_random' 
# 10개의 'OOD가 포함된 데이터셋'이 있는 폴더
DATA_BASE_DIR = 'A_k10_runs_10per_random'  

# --- 2. 평가/예측 결과 저장 위치 설정 ---

# 1. model.val()의 시각화 결과(PR curve 등)가 저장될 프로젝트
EVAL_PROJECT = 'result_k_10_10per_random'
# 2. model.predict()의 예측 이미지가 저장될 프로젝트
PREDICT_PROJECT = 'predict_imgs_k_10_10per_random'
# 3. 10개 Run의 'metrics.txt' 요약 파일이 저장될 폴더
METRICS_SUMMARY_DIR = 'k10_metrics_summary_10per_random' 
